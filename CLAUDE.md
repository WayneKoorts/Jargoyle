...
- **Extracted utilities**: pure functions (`displayTitle`, `displayUserName`, `formatDate`, `formatFileSize`, `formatRelativeTime`, `truncateWithEllipsis`) live in `src/utils/display.ts`
